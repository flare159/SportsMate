...
@WebServlet("/mvcboard/ProjectWrite.do")
@MultipartConfig(
...
public class ProjectWriteController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        req.getRequestDispatcher("/Board/ProjectWrite.jsp").forward(req, resp);
    }
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            JSFunction.alertLocation(resp, "파일 업로드 오류", "../mvcboard.ProjectWrite.do");
            return;
        }
...
////        }
        ...
        dto.setSport(req.getParameter("sport"));
        dto.setPeople(req.getParameter("people"));
        ...
        if (result == 1) {
            ...
            JSFunction.alertLocation(resp, "글쓰기 실패", "../mvcboard/ProjectWrite.do");
        }
    }
}
