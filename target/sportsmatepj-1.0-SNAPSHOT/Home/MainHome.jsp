...
<div id="main1">
    ...
    <section id="features" class="features">
        ...
        <div class="feature">
            <img src="../resources/img/jelly-dollar-jXqlkby9ylY-unsplash.jpg">
            <h2>기능 2</h2>
            <p>랭커들과의 경쟁을 통해 동기부여를 얻고, <br> 더 나은 성과를 기록해보세요.</p>
        </div>
        <div class="feature">
            <img src="../resources/img/todd-cravens-yNOdyUObPfQ-unsplash.jpg">
            <h2>기능 3</h2>
                        ...
                        <c:forEach items="${boardList}" var="row" varStatus="loop">
                            <tr align="center">
                                ...
                                <td>
                                    ...
                                    <c:choose>
                                        <c:when test="${not empty row.ofile}">
                                            <img src="/resources/img/${row.sfile}" alt="썸네일" style="object-fit: cover" width="200px" height="150px">
                                        </c:when>
                                        <c:otherwise>
                                            <img src="/resources/img/default-thumbnail.jpg" alt="기본 썸네일" style="object-fit: cover" width="200px" height="150px">
                                        </c:otherwise>
                                    </c:choose>
                                </td>
                                    <%-- 제목  --%>
                                <td align="left">
                                    ...
                                    <%-- 작성자  --%>
                                       <td><a href="../mvcboard/UserProfileServlet?userId=${row.userid}" target="_blank">${row.username}</a></td>
<%--                                        <td>${row.username}</td>--%>
                                    <%-- 조회수  --%>
